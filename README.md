...
These KPIs provide a quick view of overall sales performance.

### 🔹 Sales by City

A map visualization shows total mobile sales across different cities in India.

This helps identify geographical differences in sales performance.

### 🔹 Quantity by Month

A monthly trend chart shows the quantity of mobile phones sold from January to December.

This helps identify changes in sales volume throughout the year.

### 🔹 Customer Ratings

Customer ratings from 1 to 5 are analyzed to understand the distribution of customer ratings.

The dashboard shows that the highest volume is associated with a **5-star rating**.
...
The dashboard compares total sales across different mobile models to identify better-performing products.
...
Sales performance is analyzed across different days of the week to identify variations in daily sales.
...
Aspiring Data Analyst passionate about transforming data into meaningful insights through analysis and visualization.
